...
public class AcronymOps
    ...
    public void onConfiguration(Activity activity,
        ...
        if (firstTimeIn) {
            ...
            mAcronymWebServiceProxy = new RestAdapter.Builder().setEndpoint(AcronymWebServiceProxy.ENDPOINT).setLogLevel(LogLevel.FULL).build().create(AcronymWebServiceProxy.class);
        } else
