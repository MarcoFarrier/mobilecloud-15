...
public class AcronymProvider extends ContentProvider {
    ...
    public int bulkInsert(Uri uri,
        ...
        case ACRONYMS:
            ...
            try {
                ...
                {
                    long rowID = db.insert(AcronymContract.PATH_ACRONYM,"", cv);
                    if(rowID != -1)
                        returnCount++;
                }
    ...
    public Cursor query(Uri uri,
        ...
        case ACRONYMS: 
            ...
            // into the method.
            retCursor = queryBuilder.query(mOpenHelper.getWritableDatabase(), projection, selection, selectionArgs, null, null, sortOrder);
            break;
        case ACRONYM: 
            ...
            retCursor = queryBuilder.query(mOpenHelper.getWritableDatabase(), projection, rowId, null, null, null, sortOrder);
            break;
        default:
            throw new UnsupportedOperationException("Unknown uri: " 
                                                    + uri);
    ...
    public int update(Uri uri,
        ...
        case ACRONYMS:
            ...
            rowsUpdated = db.update(AcronymContract.PATH_ACRONYM, values, selection, selectionArgs);
            break;
        default:
            throw new UnsupportedOperationException("Unknown uri: " 
                                                    + uri);
    ...
    public int delete(Uri uri,
        ...
        case ACRONYMS:
            ...
            rowsDeleted = db.delete(AcronymContract.PATH_ACRONYM, selection, selectionArgs);
            break;
        default:
            throw new UnsupportedOperationException("Unknown uri: " 
                                                    + uri);
